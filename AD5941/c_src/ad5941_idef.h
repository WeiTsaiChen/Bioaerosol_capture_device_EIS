#ifndef AD5941_IDEF_H
#define AD5941_IDEF_H
//**********************************************************************************************************************
//
...
/**  
 * @file       ad5940.h
 * @brief      AD5941 library. This file contains all AD5941 library functions. 
 * @author     ADI
 * @date       March 2019
...
#define AD5941LIB_VER_MAJOR       0    /**< Major number */
#define AD5941LIB_VER_MINOR       2    /**< Minor number */
#define AD5941LIB_VER_PATCH       1    /**< Path number */
#define AD5941LIB_VER   (AD5941LIB_VER_MAJOR<<16)|(AD5941LIB_VER_MINOR<<8)|(AD5941LIB_VER_PATCH)
...
/** 
 * @cond
 * @defgroup AD5941RegistersBitfields
 * @brief All AD5941 registers and bitfields definition.
 * @{
*/
 ...
 * @brief AD5941 has two interrupt controller INTC0 and INTC1. Both of them have ability to generate interrupt signal from GPIO.
 * @{
 * */
...
#define AFEINTSRC_CRC_OUTLIER       0x20000000  /**<  Bit29, CRC interrupt for M355, Outlier Int for AD5941  */
#define AFEINTSRC_GPT0INT_SLPWUT    0x40000000  /**<  Bit30, Gneral Pupose Timer0 IRQ for M355. Sleep or Wakeup Tiemr timeout for AD5941*/
#define AFEINTSRC_GPT1INT_TRYBRK    0x80000000  /**<  Bit31, Gneral Pupose Timer1 IRQ for M355. Tried to Break IRQ for AD5941*/
 ...
 * @details This is all the available control signal for function @ref AD5941_AFECtrlS
 * @warning Bit field in register AFECON has some opposite meaning as below definitions. We use all positive word here
 *          like HPREF instead of HPREFDIS. This set is only used in function @ref AD5941_AFECtrlS, the second parameter
 ...
 * @details  This is all the available control signal for function @ref AD5941_LPModeCtrlS
 * @warning Bit field in register LPMODECON has some opposite meaning as below definitions. We use all positive word here
 *          like HPREFPWR instead of HPREFDIS. This set is only used in function @ref AD5941_AFECtrlS, the second parameter
 ...
 * @brief The available AFE results type. Used for function @ref AD5941_ReadAfeResult
 * @{
*/
...
#define ADCMUXP_VAFE3               0xF     /**< Voltage of AFE3 pin on AD5941. */
...
#define ADCMUXP_VAFE4               0x1B    /**< Voltage of AFE4 pin on AD5941. */
#define ADCMUXP_VBIAS1              0x1C    /**< Voltage of Vbias1 pin  */
#define ADCMUXP_VCE1                0x1D    /**< Voltage of CE1 pin on ADuCM355. */
#define ADCMUXP_VAFE1               0x1D    /**< Voltage of AFE1 pin on AD5941. */
#define ADCMUXP_VRE1                0x1E    /**< Voltage of RE1 pin on ADuCM355. */
#define ADCMUXP_VAFE2               0x1E    /**< Voltage of AFE2 pin on AD5941. */
...
#define ADCMUXN_AFE4                0x12     /**< Pin AFE4 on AD5941. */
 ...
 * @{
*/
#define AGPIO_Pin0                  0x01  /**< AFE GPIO0, only available on AD5941 and AD5941, not ADuCM355 */
#define AGPIO_Pin1                  0x02  /**< AFE GPIO1, only available on AD5941 and AD5941, not ADuCM355 */
#define AGPIO_Pin2                  0x04  /**< AFE GPIO2, only available on AD5941 and AD5941, not ADuCM355 */
 ...
 * @brief Select system clock source. The clock must be available. If unavailable clock is selected, we can reset AD5941.
...
/**
 * @defgroup AD5941ERR_Const
 * @brief AD5941 error code used by library and example codes.
 * @{
*/
#define AD5941ERR_OK               0  /**< No error */
#define AD5941ERR_ERROR           -1  /**< General error message */
#define AD5941ERR_PARA            -2  /**< Parameter is illegal */ 
#define AD5941ERR_NULLP           -3  /**< Null pointer */ 
#define AD5941ERR_BUFF            -4  /**< Buffer limited. */
#define AD5941ERR_ADDROR          -5  /**< Out of Range. Register address is out of range. */ 
#define AD5941ERR_SEQGEN          -6  /**< Sequence generator error */ 
#define AD5941ERR_SEQREG          -7  /**< Register info is not found */
#define AD5941ERR_SEQLEN          -8  /**< Sequence length is too long. */
#define AD5941ERR_WAKEUP          -9  /**< Unable to wakeup AFE in specified time */
#define AD5941ERR_TIMEOUT         -10 /**< Time out error. */
#define AD5941ERR_CALOR           -11 /**< calibration out of range. */
#define AD5941ERR_APPERROR        -100  /**< Used in example code to indicated the application has not been initialized. */
/** @} */
...
#define AD5941_ADIID              0x4144      /**< ADIID is fixed to 0x4144 */
#define AD5941_CHIPID             0x0000      /**< CHIPID is changing with silicon version */
#define M355_ADIID                0x4144      /**< ADIID is fixed to 0x4144 */
#define M355_CHIPID               0x0000      /**< CHIPID is changing with silicon version */

#define AD5941_SWRST              0xa158      /**< AD594x only. The value to perform software reset via reigster SWRSTCON */
...
typedef int32_t AD5941Err;    /**< error number defination */
...
typedef struct
{
  ...
  uint32_t ADCAvgNum;           /**< Average filter is enabled when DFT source is @ref DFTSRC_AVG in function @ref AD5941_DFTCfgS. This average filter is only used by DFT engine. */
...
typedef struct
{
  ...
  uint32_t SeqxSleepTime[4];  /**< Time before put AFE to sleep. 0 to 0x000f_ffff. We normally don't use this feature and it's disabled in @ref AD5941_Initialize */
...
typedef struct
{
  ...
  BoolFlag      SPI_CS;
  BoolFlag      SPI_SCLK;
  uint16_t      SPI_READ_DATA;
  int           SPIRWtimes;
  uint32_t      SPI_RW_DATA_32;
  uint8_t       SPI_RW_DATA_8_List[5];
}SPIParams_Type;
