...
extern "C"
{
    ...
    const UINT32 gt_fk_portsource_register[]=
    {
        ...
        EXTI_PortSourceGPIOC,EXTI_PortSourceGPIOD,
    ...
    {
        RCC_APB1Periph_TIM5,RCC_APB1Periph_TIM2,RCC_APB1Periph_TIM3,RCC_APB1Periph_TIM4,RCC_APB2Periph_TIM9
    };

    const UINT32 gt_fk_timer_register[]=
    {
        TIM5_BASE,TIM2_BASE,TIM3_BASE,TIM4_BASE,TIM9_BASE
    };

    const UINT32 gt_fk_timer_irq[]=
    {
        TIM5_IRQn,TIM2_IRQn,TIM3_IRQn,TIM4_IRQn,TIM9_IRQn
    };

    const UINT8 gt_fk_timer_priority[]=
    {
        FK_TIM5_CC_PRIORITY,FK_TIM2_PRIORITY,FK_TIM3_PRIORITY,FK_TIM4_PRIORITY,FK_TIM9_PRIORITY
    };
    ...
    {
        GPIOA_BASE,GPIOB_BASE,GPIOD_BASE,GPIOA_BASE,GPIOD_BASE,GPIOB_BASE,
    };
    const UINT32 gt_fk_uart_tx_pin_register[]=
    {
        FK_PIN9,FK_PIN6,FK_PIN5,FK_PIN2,FK_PIN8,FK_PIN10,
    };
    const UINT32 gt_fk_uart_rx_pin_register[]=
    {
        FK_PIN10,FK_PIN7,FK_PIN6,FK_PIN3,FK_PIN9,FK_PIN11,
    };
    ...
    {
        GPIO_AF_USART1,GPIO_AF_USART1,GPIO_AF_USART2,GPIO_AF_USART2,GPIO_AF_USART3,GPIO_AF_USART3,
    };
    ...
    const UINT32 gt_fk_spi_af_register[]=
    {
    ...
    const UINT32 gt_fk_dac_timer_rcc[]=
    {
            RCC_APB1Periph_TIM6,RCC_APB1Periph_TIM7,
    };
    const UINT32 gt_fk_dac_timer[]=
    {
            (UINT32)TIM6,(UINT32)TIM7,
    };
    const UINT32 gt_fk_dac_trigger[]=
    {
            DAC_Trigger_T6_TRGO,DAC_Trigger_T7_TRGO,
    };
    const UINT32 gt_fk_dac_wave[]=
    {
            DAC_WaveGeneration_None,DAC_WaveGeneration_Noise,DAC_WaveGeneration_Triangle,
    };
//**********************************************************************************************************************
//
// Copyright (C) 2010, FINE-TEK CO.,LTD. Taiwan  All Rights Reserved
