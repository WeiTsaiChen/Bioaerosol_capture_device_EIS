...
//**********************************************************************************************************************
    ...
    EXTERNAL void (*gfunc_fk_timer_interrupt[FK_INTERRUPT_FUNC_TOTAL])(void);
    ...
    extern const UINT32 gt_fk_dac_timer_rcc[];
    extern const UINT32 gt_fk_dac_timer[];
    extern const UINT32 gt_fk_dac_trigger[];
    extern const UINT32 gt_fk_dac_wave[];
    extern const UINT32 gt_fk_spi_af_register[];
